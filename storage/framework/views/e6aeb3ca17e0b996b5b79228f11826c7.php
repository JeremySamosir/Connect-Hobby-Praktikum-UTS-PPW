...
<head>
    ...
    <link rel="stylesheet" href="css/lihat_ulasan.css">
    <link rel="stylesheet" href="css/sidebar_dm.css">
    <link rel="stylesheet" href="css/navbar_dm.css">
    <?php echo $__env->make('sidebar_dm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('navbar_dm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</head>
<body>
<!-- Navbar -->
...
<table>
  ...
  <tr>
    ...
    <td>Gedung 711</td>
    <td><button type="button" class="btn btn-secondary">Lihat Detail</button></td>
  </tr>
  <tr>
    <td>2</td>
  ...
  <tr>
    ...
    <script src="jss/index.js" defer></script><?php /**PATH C:\Users\Indah\Herd\ppw\resources\views/lihat_ulasan.blade.php ENDPATH**/ ?>